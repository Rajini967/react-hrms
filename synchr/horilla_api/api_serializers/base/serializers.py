...
class AnnouncementExpireSerializer(serializers.ModelSerializer):
    class Meta:
        model = AnnouncementExpire
        fields = "__all__"


class DynamicPaginationSerializer(serializers.ModelSerializer):
    class Meta:
...
class AccountBlockUnblockSerializer(serializers.ModelSerializer):
    class Meta:
        model = AccountBlockUnblock
        fields = "__all__"


class ProfileEditFeatureSerializer(serializers.ModelSerializer):
    class Meta:
        model = ProfileEditFeature
        fields = "__all__"
...
class GoogleDriveBackupSerializer(serializers.ModelSerializer):
    class Meta:
        model = GoogleDriveBackup
        fields = "__all__"


class DefaultAccessibilitySerializer(serializers.ModelSerializer):
    class Meta:
        model = DefaultAccessibility
        fields = "__all__"
