...
urlpatterns = [
    ...
    path('dashboard/', views.EmployeeDashboardAPIView.as_view(), name='employee-dashboard'),
    path('role-based-list/', views.RoleBasedEmployeeListAPIView.as_view(), name='role-based-employee-list'),
    path("employee-tags/", views.EmployeeTagAPIView.as_view(), name="api-employee-tags"),
    path("employee-tags/<int:pk>/", views.EmployeeTagAPIView.as_view(), name="api-employee-tags-detail"),
]
