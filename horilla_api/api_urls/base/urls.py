...
urlpatterns = [
    ...
    path(
        "email-configuration/",
        views.DynamicEmailConfigurationView.as_view(),
        name="api-email-configuration"
    ),
    path("groups/", views.GroupView.as_view(), name="api-groups"),
    path("groups/<int:pk>/", views.GroupView.as_view(), name="api-groups-detail"),
    path("permissions/", views.PermissionView.as_view(), name="api-permissions"),
    path("audit-tags/", views.AuditTagView.as_view(), name="api-audit-tags"),
    path("audit-tags/<int:pk>/", views.AuditTagView.as_view(), name="api-audit-tags-detail"),
    path("gdrive-backup/", views.GoogleDriveBackupView.as_view(), name="api-gdrive-backup"),
    path("accessibility/", views.DefaultAccessibilityView.as_view(), name="api-accessibility"),
    path("employee-permissions/<int:pk>/", views.EmployeePermissionView.as_view(), name="api-employee-permissions"),
]
